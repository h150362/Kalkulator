	...
	public Grensesnitt() {
		...
		pluss.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int result = Kalkulator2.add(number1, number2);
		...
		minus.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int number1 =Integer.parseInt(tall1.getText());
				int number2 = Integer.parseInt(tall2.getText());
				int result = Kalkulator2.sub(number1, number2);
		...
		mul.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int number1 =Integer.parseInt(tall1.getText());
				int number2 = Integer.parseInt(tall2.getText());
				int result = Kalkulator2.mul(number1, number2);
		...
		div.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int number1 =Integer.parseInt(tall1.getText());
				int number2 = Integer.parseInt(tall2.getText());
				int result = Kalkulator2.div(number1, number2);
